...
@Configuration
@Slf4j
public class OriginalListener implements AcknowledgingMessageListener<String, OriginalMessage> {

  @Override
  @KafkaListener(topics = {KafkaTopic.ORIGINAL}, errorHandler = "kafkaListenerErrorHandler")
  @SendTo(KafkaTopic.RETRY)
